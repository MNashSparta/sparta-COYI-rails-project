Rails.application.routes.draw do
  ...
  get 'profile/my_resources/:id', to: 'resources#show_user_my_resource', as: 'show_user_my_resource'
  ...
  get 'profile/my_resources', to: 'my_resources#user_my_resources', as: 'user_my_resources'
